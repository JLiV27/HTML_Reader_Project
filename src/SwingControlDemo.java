...
public class SwingControlDemo implements ActionListener {
    ...
    public SwingControlDemo() { //calls prepare gui when program starts
        prepareGUI();
    }

    public static void main(String[] args) { //calls showeventdemo
        SwingControlDemo swingControlDemo = new SwingControlDemo();
        swingControlDemo.showEventDemo();
    }

    private void prepareGUI() { //method runs once when program starts and sets up mainframe and toolbar
    ...
    private void showEventDemo() { //runs once when program starts and puts together starting gui
    ...
    private class ButtonClickListener implements ActionListener {
        public void actionPerformed(ActionEvent e) { //method to take command set by button listener and execute an action based off it
            ...
            if (command.equals("Start")) { //Once start of the program start button is pressed, sets up new GUI for all the input boxes and Read HTML button
                ...
                String line;
                while (true) { //while loop that checks each line of the html code
                    try {
        ...
        private BufferedReader getBufferedReader() { //method to actually connect to the website provided by the link
